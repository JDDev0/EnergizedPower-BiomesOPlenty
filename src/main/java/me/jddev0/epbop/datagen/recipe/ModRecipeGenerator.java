...
public class ModRecipeGenerator extends RecipeProvider implements IConditionBuilder {
    ...
    private void buildSawmillRecipes(RecipeOutput output) {
        addBasicWoodSawmillRecipe(output, new ItemStack(BOPItems.FIR_PLANKS),
                ...
                ingredientOf(BOPItems.FIR_SIGN), ingredientOf(BOPItems.FIR_BOAT), ingredientOf(BOPItems.FIR_CHEST_BOAT),
                false, "fir");
        ...
        addBasicWoodSawmillRecipe(output, new ItemStack(BOPItems.PINE_PLANKS),
                ...
                ingredientOf(BOPItems.PINE_SIGN), ingredientOf(BOPItems.PINE_BOAT), ingredientOf(BOPItems.PINE_CHEST_BOAT),
                false, "pine");
        ...
        addBasicWoodSawmillRecipe(output, new ItemStack(BOPItems.MAPLE_PLANKS),
                ...
                ingredientOf(BOPItems.MAPLE_SIGN), ingredientOf(BOPItems.MAPLE_BOAT), ingredientOf(BOPItems.MAPLE_CHEST_BOAT),
                false, "maple");
        ...
        addBasicWoodSawmillRecipe(output, new ItemStack(BOPItems.REDWOOD_PLANKS),
                ...
                ingredientOf(BOPItems.REDWOOD_SIGN), ingredientOf(BOPItems.REDWOOD_BOAT), ingredientOf(BOPItems.REDWOOD_CHEST_BOAT),
                false, "redwood");
        ...
        addBasicWoodSawmillRecipe(output, new ItemStack(BOPItems.MAHOGANY_PLANKS),
                ...
                ingredientOf(BOPItems.MAHOGANY_SIGN), ingredientOf(BOPItems.MAHOGANY_BOAT), ingredientOf(BOPItems.MAHOGANY_CHEST_BOAT),
                false, "mahogany");
        ...
        addBasicWoodSawmillRecipe(output, new ItemStack(BOPItems.JACARANDA_PLANKS),
                ...
                ingredientOf(BOPItems.JACARANDA_SIGN), ingredientOf(BOPItems.JACARANDA_BOAT), ingredientOf(BOPItems.JACARANDA_CHEST_BOAT),
                false, "jacaranda");
        ...
        addBasicWoodSawmillRecipe(output, new ItemStack(BOPItems.PALM_PLANKS),
                ...
                ingredientOf(BOPItems.PALM_SIGN), ingredientOf(BOPItems.PALM_BOAT), ingredientOf(BOPItems.PALM_CHEST_BOAT),
                false, "palm");
        ...
        addBasicWoodSawmillRecipe(output, new ItemStack(BOPItems.WILLOW_PLANKS),
                ...
                ingredientOf(BOPItems.WILLOW_SIGN), ingredientOf(BOPItems.WILLOW_BOAT), ingredientOf(BOPItems.WILLOW_CHEST_BOAT),
                false, "willow");
        ...
        addBasicWoodSawmillRecipe(output, new ItemStack(BOPItems.DEAD_PLANKS),
                ...
                ingredientOf(BOPItems.DEAD_SIGN), ingredientOf(BOPItems.DEAD_BOAT), ingredientOf(BOPItems.DEAD_CHEST_BOAT),
                false, "dead");
        ...
        addBasicWoodSawmillRecipe(output, new ItemStack(BOPItems.MAGIC_PLANKS),
                ...
                ingredientOf(BOPItems.MAGIC_SIGN), ingredientOf(BOPItems.MAGIC_BOAT), ingredientOf(BOPItems.MAGIC_CHEST_BOAT),
                false, "magic");
        ...
        addBasicWoodSawmillRecipe(output, new ItemStack(BOPItems.UMBRAN_PLANKS),
                ...
                ingredientOf(BOPItems.UMBRAN_SIGN), ingredientOf(BOPItems.UMBRAN_BOAT), ingredientOf(BOPItems.UMBRAN_CHEST_BOAT),
                false, "umbran");
        ...
        addBasicWoodSawmillRecipe(output, new ItemStack(BOPItems.HELLBARK_PLANKS),
                ...
                ingredientOf(BOPItems.HELLBARK_SIGN), ingredientOf(BOPItems.HELLBARK_BOAT), ingredientOf(BOPItems.HELLBARK_CHEST_BOAT),
                false, "hellbark");
        ...
        addBasicWoodSawmillRecipe(output, new ItemStack(BOPItems.EMPYREAL_PLANKS),
                ...
                ingredientOf(BOPItems.EMPYREAL_SIGN), ingredientOf(BOPItems.EMPYREAL_BOAT), ingredientOf(BOPItems.EMPYREAL_CHEST_BOAT),
                false, "empyreal");
    }
    ...
    private void buildPlantGrowthChamberRecipes(RecipeOutput output) {
        ...
        addPlantGrowthChamberRecipe(output, ingredientOf(BOPItems.WILDFLOWER), new OutputItemStackWithPercentages[] {
