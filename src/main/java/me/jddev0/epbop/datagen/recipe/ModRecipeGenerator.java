...
public class ModRecipeGenerator extends RecipeProvider {
    ...
    private void buildCrusherRecipes(RecipeOutput output) {
        addCrusherRecipe(output, ingredientOf(BOPItems.WHITE_SANDSTONE), new ItemStackTemplate(BOPItems.WHITE_SAND),
                "white_sandstone");
        ...
        addCrusherRecipe(output, ingredientOf(BOPItems.ORANGE_SANDSTONE), new ItemStackTemplate(BOPItems.ORANGE_SAND),
                "orange_sandstone");
        ...
        addCrusherRecipe(output, ingredientOf(BOPItems.BLACK_SANDSTONE), new ItemStackTemplate(BOPItems.BLACK_SAND),
                "black_sandstone");
    ...
    private void buildSawmillRecipes(RecipeOutput output) {
        addBasicWoodSawmillRecipe(output, new ItemStackTemplate(BOPItems.ORIGIN_OAK_PLANKS),
        ...
        addBasicWoodSawmillRecipe(output, new ItemStackTemplate(BOPItems.FIR_PLANKS),
        ...
        addBasicWoodSawmillRecipe(output, new ItemStackTemplate(BOPItems.PINE_PLANKS),
        ...
        addBasicWoodSawmillRecipe(output, new ItemStackTemplate(BOPItems.MAPLE_PLANKS),
        ...
        addBasicWoodSawmillRecipe(output, new ItemStackTemplate(BOPItems.REDWOOD_PLANKS),
        ...
        addBasicWoodSawmillRecipe(output, new ItemStackTemplate(BOPItems.MAHOGANY_PLANKS),
        ...
        addBasicWoodSawmillRecipe(output, new ItemStackTemplate(BOPItems.JACARANDA_PLANKS),
        ...
        addBasicWoodSawmillRecipe(output, new ItemStackTemplate(BOPItems.PALM_PLANKS),
        ...
        addBasicWoodSawmillRecipe(output, new ItemStackTemplate(BOPItems.WILLOW_PLANKS),
        ...
        addBasicWoodSawmillRecipe(output, new ItemStackTemplate(BOPItems.DEAD_PLANKS),
        ...
        addBasicWoodSawmillRecipe(output, new ItemStackTemplate(BOPItems.MAGIC_PLANKS),
        ...
        addBasicWoodSawmillRecipe(output, new ItemStackTemplate(BOPItems.UMBRAN_PLANKS),
        ...
        addBasicWoodSawmillRecipe(output, new ItemStackTemplate(BOPItems.HELLBARK_PLANKS),
        ...
        addBasicWoodSawmillRecipe(output, new ItemStackTemplate(BOPItems.EMPYREAL_PLANKS),
    ...
    private void addCrusherRecipe(RecipeOutput recipeOutput, Ingredient input, ItemStackTemplate output, String recipeIngredientName) {
